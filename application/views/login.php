...
<html>
  <head>
    <meta charset="utf-8">
    <title>Login | Humas | Bayt Al-Hikmah</title>
      ...
      <form class="form-signin" style="background-color: #fff;" role="form" action="app/login" method="post">
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" style="background-color: #fff; color: #333" class="form-control" name="username" id="username" placeholder="Username" autocomplete="off" autofocus />
          </div>
        </div>
